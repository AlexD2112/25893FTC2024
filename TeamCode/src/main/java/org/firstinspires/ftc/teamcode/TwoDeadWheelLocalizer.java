...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1145.721443241929; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2208.3388718975234; // x position of the perpendicular encoder (in tick units)
    }
